    ...
    configureGrunt = function (grunt) {
        ...
        var cfg = {
            ...
            watch: {
                ...
                compass: {
                    files: ['content/themes/carapace/assets/scss/*.scss'],
                    tasks: ['compass']
                },
                concat: {
                    files: [
                ...
                livereload: {
                    files: [
                        // Theme CSS
                        'content/themes/carapace/assets/css/*.css',
                        // Theme JS
                        'content/themes/carapace/assets/js/*.js',
                        // Admin CSS
            ...
            compass:  {
                dist:  {
                    options:  {
                            config: 'content/themes/carapace/config.rb',
                            sassDir: 'content/themes/carapace/assets/scss',
                            cssDir: 'content/themes/carapace/assets/css',
        ...
        grunt.registerTask('prod', ['sass:admin', 'compass', 'handlebars', 'concat', 'uglify']);

        // When you just say 'grunt'
        grunt.registerTask('default', ['sass:admin', 'compass', 'handlebars', 'concat']);
    };
